...
def td3(env_name, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0, 
    ...
    # TODO
    #  gym origin env, just use env_fn()
    #  mbrl env, use params and env.env()

    # env, test_env = env_fn(), env_fn()
    from mbbl.env.gym_env import walker
    env = walker.env(env_name=env_name, rand_seed=1234,
                              misc_info={'reset_type': 'gym'})
    test_env = walker.env(env_name=env_name, rand_seed=1234,
                              misc_info={'reset_type': 'gym'})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='gym_cheetah')
    ...
    td3(args.env, actor_critic=core.mlp_actor_critic,
