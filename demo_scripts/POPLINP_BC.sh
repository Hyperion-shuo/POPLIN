...
python ../scripts/mbexp.py -logdir ../log/POPLINP_BC_pusher -env pusher \
...
python ../scripts/mbexp.py -logdir ../log/POPLINP_BC_reacher -env reacher \
    -o exp_cfg.exp_cfg.ntrain_iters 50 \
    -o ctrl_cfg.cem_cfg.cem_type POPLINP-SEP \
    -o ctrl_cfg.cem_cfg.training_scheme BC-PR \
    -o ctrl_cfg.cem_cfg.policy_network_shape [32] \
...
python ../scripts/mbexp.py -logdir ../log/POPLINP_BC_halfcheetah -env halfcheetah \
    -o exp_cfg.exp_cfg.ntrain_iters 50 \
    -o ctrl_cfg.cem_cfg.cem_type POPLINP-SEP \
    -o ctrl_cfg.cem_cfg.training_scheme BC-PR \
    -o ctrl_cfg.cem_cfg.policy_network_shape [32] \
